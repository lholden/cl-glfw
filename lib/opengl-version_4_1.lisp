...
(eval-when (:load-toplevel)
  (when
      (and (boundp '*version-loaded*) (not (eq 'version_4_1 *version-loaded*)))
    (warn
     "Loading cl-glfw-opengl-~a over the top of already-loaded cl-glfw-opengl-~a~%"
     'version_4_1 *version-loaded*))
  (defparameter *version-loaded* 'version_4_1)) 
...
(make-extension-loader version_4_1
