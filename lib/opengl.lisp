...
|load-extension-VERSION_2_1| 
blend-func-separate-ingr 
|load-extension-INGR_blend_func_separate| 
igloo-interface-sgix 
|load-extension-SGIX_igloo_interface| 
+texture2-arb+ 
+texture3-arb+ 
+texture4-arb+ 
+texture5-arb+ 
...
client-active-texture-arb 
active-texture-arb 
|load-extension-ARB_multitexture| 
...
|load-extension-ARB_transpose_matrix| 
+multisample+ 
...
+multisample-bit-arb+ 
sample-coverage-arb 
|load-extension-ARB_multisample| 
...
|load-extension-ARB_texture_compression| 
point-parameter-fv-arb 
point-parameter-f-arb 
|load-extension-ARB_point_parameters| 
...
weight-sv-arb 
weight-bv-arb 
|load-extension-ARB_vertex_blend| 
+matrix-palette-arb+ 
...
current-palette-matrix-arb 
|load-extension-ARB_matrix_palette| 
window-pos-3sv-arb 
window-pos-3s-arb 
window-pos-3iv-arb 
window-pos-3i-arb 
...
|load-extension-ARB_vertex_program| 
+buffer-size-arb+ 
+buffer-usage-arb+ 
+array-buffer-arb+ 
...
delete-buffers-arb 
bind-buffer-arb 
|load-extension-ARB_vertex_buffer_object| 
...
delete-queries-arb 
gen-queries-arb 
|load-extension-ARB_occlusion_query| 
+program-object-arb+ 
+shader-object-arb+ 
+object-type-arb+ 
+object-subtype-arb+ 
...
get-handle-arb 
delete-object-arb 
|load-extension-ARB_shader_objects| 
+vertex-shader-arb+ 
...
|load-extension-ARB_vertex_shader| 
...
+draw-buffer15-arb+ 
draw-buffers-arb 
|load-extension-ARB_draw_buffers| 
+rgba-float-mode-arb+ 
...
+fixed-only-arb+ 
clamp-color-arb 
|load-extension-ARB_color_buffer_float| 
blend-color-ext 
|load-extension-EXT_blend_color| 
+polygon-offset-ext+ 
+polygon-offset-factor-ext+ 
polygon-offset-ext 
|load-extension-EXT_polygon_offset| 
+pack-skip-images+ 
+pack-image-height+ 
+unpack-skip-images+ 
+unpack-image-height+ 
...
|load-extension-EXT_convolution| 
...
color-table-sgi 
|load-extension-SGI_color_table| 
...
|load-extension-SGIS_pixel_texture| 
pixel-tex-gen-sgix 
|load-extension-SGIX_pixel_texture| 
tex-sub-image-4d-sgis 
tex-image-4d-sgis 
|load-extension-SGIS_texture4D| 
...
|load-extension-EXT_texture_object| 
get-detail-tex-func-sgis 
detail-tex-func-sgis 
|load-extension-SGIS_detail_texture| 
get-sharpen-tex-func-sgis 
sharpen-tex-func-sgis 
|load-extension-SGIS_sharpen_texture| 
sample-pattern-sgis 
sample-mask-sgis 
|load-extension-SGIS_multisample| 
+vertex-array-ext+ 
+normal-array-ext+ 
+color-array-ext+ 
+index-array-ext+ 
...
color-pointer-ext 
array-element-ext 
|load-extension-EXT_vertex_array| 
blend-equation-ext 
|load-extension-EXT_blend_minmax| 
+sprite-axial-sgix+ 
...
|load-extension-SGIX_sprite| 
point-parameter-fv-ext 
point-parameter-f-ext 
|load-extension-EXT_point_parameters| 
+point-size-min+ 
+point-size-min-arb+ 
+point-size-min-ext+ 
+point-size-max+ 
...
|load-extension-SGIS_point_parameters| 
...
|load-extension-SGIX_instruments| 
frame-zoom-sgix 
|load-extension-SGIX_framezoom| 
tag-sample-buffer-sgix 
|load-extension-SGIX_tag_sample_buffer| 
load-identity-deformation-map-sgix 
deform-sgix 
deformation-map-3f-sgix 
deformation-map-3d-sgix 
|load-extension-SGIX_polynomial_ffd| 
reference-plane-sgix 
|load-extension-SGIX_reference_plane| 
flush-raster-sgix 
|load-extension-SGIX_flush_raster| 
get-fog-func-sgis 
fog-func-sgis 
|load-extension-SGIS_fog_function| 
+image-scale-x-hp+ 
+image-scale-y-hp+ 
...
|load-extension-HP_image_transform| 
copy-color-sub-table-ext 
color-sub-table-ext 
|load-extension-EXT_color_subtable| 
...
get-color-table-ext 
color-table-ext 
|load-extension-EXT_paletted_texture| 
...
fragment-color-material-sgix 
|load-extension-SGIX_fragment_lighting| 
+max-elements-vertices-ext+ 
+max-elements-indices-ext+ 
draw-range-elements-ext 
|load-extension-EXT_draw_range_elements| 
...
texture-light-ext 
apply-texture-ext 
|load-extension-EXT_light_texture| 
...
|load-extension-INTEL_parallel_arrays| 
...
|load-extension-EXT_pixel_transform| 
+color-sum-ext+ 
...
|load-extension-EXT_secondary_color| 
+perturb-ext+ 
+texture-normal-ext+ 
texture-normal-ext 
|load-extension-EXT_texture_perturb_normal| 
multi-draw-elements-ext 
multi-draw-arrays-ext 
|load-extension-EXT_multi_draw_arrays| 
...
tangent-3bv-ext 
tangent-3b-ext 
|load-extension-EXT_coordinate_frame| 
+unpack-constant-data-sunx+ 
+texture-constant-data-sunx+ 
finish-texture-sunx 
|load-extension-SUNX_constant_data| 
+global-alpha-sun+ 
...
|load-extension-SUN_global_alpha| 
+restart-sun+ 
+replace-middle-sun+ 
+replace-oldest-sun+ 
+triangle-list-sun+ 
...
|load-extension-SUN_triangle_list| 
...
|load-extension-SUN_vertex| 
+blend-dst-rgb-ext+ 
+blend-src-rgb-ext+ 
+blend-dst-alpha-ext+ 
+blend-src-alpha-ext+ 
blend-func-separate-ext 
|load-extension-EXT_blend_func_separate| 
...
vertex-weight-f-ext 
|load-extension-EXT_vertex_weighting| 
...
|load-extension-NV_vertex_array_range| 
...
|load-extension-NV_register_combiners| 
resize-buffers-mesa 
|load-extension-MESA_resize_buffers| 
window-pos-4sv-mesa 
window-pos-4s-mesa 
window-pos-4iv-mesa 
window-pos-4i-mesa 
...
window-pos-2dv-mesa 
window-pos-2d-mesa 
|load-extension-MESA_window_pos| 
multi-mode-draw-elements-ibm 
multi-mode-draw-arrays-ibm 
|load-extension-IBM_multimode_draw_arrays| 
...
|load-extension-IBM_vertex_array_lists| 
tbuffer-mask-3dfx 
|load-extension-3DFX_tbuffer| 
+multisample-ext+ 
...
sample-pattern-ext 
sample-mask-ext 
|load-extension-EXT_multisample| 
+texture-color-writemask-sgis+ 
texture-color-mask-sgis 
|load-extension-SGIS_texture_color_mask| 
+all-completed-nv+ 
+fence-status-nv+ 
+fence-condition-nv+ 
set-fence-nv 
...
|load-extension-NV_vertex_program| 
+bump-rot-matrix-ati+ 
...
|load-extension-ATI_envmap_bumpmap| 
+fragment-shader-ati+ 
+reg-0-ati+ 
+reg-1-ati+ 
+reg-2-ati+ 
...
|load-extension-ATI_fragment_shader| 
+pn-triangles-ati+ 
...
pntriangles-f-ati 
pntriangles-i-ati 
|load-extension-ATI_pn_triangles| 
+static-ati+ 
+dynamic-ati+ 
+preserve-ati+ 
+discard-ati+ 
...
|load-extension-ATI_vertex_array_object| 
+vertex-shader-ext+ 
...
|load-extension-EXT_vertex_shader| 
...
|load-extension-ATI_vertex_streams| 
+element-array-ati+ 
...
element-pointer-ati 
|load-extension-ATI_element_array| 
+quad-mesh-sun+ 
+triangle-mesh-sun+ 
draw-mesh-arrays-sun 
|load-extension-SUN_mesh_array| 
...
|load-extension-APPLE_element_array| 
+draw-pixels-apple+ 
+fence-apple+ 
finish-object-apple 
test-object-apple 
...
vertex-array-range-apple 
|load-extension-APPLE_vertex_array_range| 
...
+draw-buffer15-ati+ 
draw-buffers-ati 
|load-extension-ATI_draw_buffers| 
...
|load-extension-NV_fragment_program| 
+half-float-nv+ 
...
pixel-data-range-nv 
|load-extension-NV_pixel_data_range| 
+primitive-restart-nv+ 
+primitive-restart-index-nv+ 
primitive-restart-index-nv 
primitive-restart-nv 
|load-extension-NV_primitive_restart| 
unmap-object-buffer-ati 
map-object-buffer-ati 
|load-extension-ATI_map_object_buffer| 
...
|load-extension-NV_gpu_program4| 
+geometry-program-nv+ 
...
|load-extension-NV_geometry_program4| 
+geometry-shader-ext+ 
...
|load-extension-EXT_geometry_shader4| 
...
|load-extension-NV_vertex_program4| 
...
get-uniform-uiv-ext 
|load-extension-EXT_gpu_shader4| 
draw-elements-instanced-ext 
draw-arrays-instanced-ext 
|load-extension-EXT_draw_instanced| 
+texture-buffer-ext+ 
...
tex-buffer-ext 
|load-extension-EXT_texture_buffer_object| 
...
clear-depthd-nv 
depth-ranged-nv 
|load-extension-NV_depth_buffer_float| 
...
|load-extension-NV_framebuffer_multisample_coverage| 
...
|load-extension-NV_parameter_buffer_object| 
...
|load-extension-EXT_draw_buffers2| 
...
|load-extension-NV_transform_feedback| 
...
uniform-buffer-ext 
|load-extension-EXT_bindable_uniform| 
+rgba32ui-ext+ 
+rgb32ui-ext+ 
+alpha32ui-ext+ 
+intensity32ui-ext+ 
...
|load-extension-EXT_texture_integer| ))
