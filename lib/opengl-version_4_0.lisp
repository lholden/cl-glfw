...
(defglfun "BlendFuncSeparatei" blend-func-separate-i :return "void" :args
...
(defglfun "BlendFunci" blend-func-i :return "void" :args
 ((:name |buf| :type |UInt32| :direction :in)
  (:name |src| :type |GLenum| :direction :in)
  (:name |dst| :type |GLenum| :direction :in))
 :category "VERSION_4_0" :deprecated nil :version "1.2") 
(defglfun "BlendEquationSeparatei" blend-equation-separate-i :return "void"
 :args
 ((:name |buf| :type |UInt32| :direction :in)
  (:name |modeRGB| :type |GLenum| :direction :in)
  (:name |modeAlpha| :type |GLenum| :direction :in))
 :category "VERSION_4_0" :deprecated nil :version "1.2") 
(defglfun "BlendEquationi" blend-equation-i :return "void" :args
 ((:name |buf| :type |UInt32| :direction :in)
  (:name |mode| :type |GLenum| :direction :in))
 :category "VERSION_4_0" :deprecated nil :version "1.2") 
(defglfun "MinSampleShading" min-sample-shading :return "void" :args
