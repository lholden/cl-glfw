...
(eval-when (:load-toplevel)
  (when
      (and (boundp '*version-loaded*) (not (eq 'version_3_2 *version-loaded*)))
    (warn
     "Loading cl-glfw-opengl-~a over the top of already-loaded cl-glfw-opengl-~a~%"
     'version_3_2 *version-loaded*))
  (defparameter *version-loaded* 'version_3_2)) 
...
(defglextfun "GetInteger64i_v" get-integer-64i_v :return "void" :args
 ...
 :category "VERSION_3_2" :deprecated nil :version "3.2") 
(make-extension-loader version_3_2
