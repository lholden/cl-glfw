...
(defpackage #:cl-glfw-opengl
            ...
            (:export #:enum #:boolean #:bitfield #:byte #:short #:int #:sizei
             ...
             #:+multisample+ #:+sample-alpha-to-coverage+
             ...
             #:point-parameter-fv-arb #:point-parameter-f-arb
             ...
             #:weight-sv-arb #:weight-bv-arb #:+matrix-palette-arb+
             ...
             #:vertex-attrib-1dv-arb #:vertex-attrib-1d-arb #:+buffer-size-arb+
             #:+buffer-usage-arb+ #:+array-buffer-arb+
             ...
             #:+query-counter-bits-arb+ #:+current-query-arb+
             #:+query-result-arb+ #:+query-result-available-arb+
             #:+samples-passed-arb+ #:get-query-object-uiv-arb
             #:get-query-object-iv-arb #:get-query-iv-arb #:end-query-arb
             #:begin-query-arb #:is-query-arb #:delete-queries-arb
             #:gen-queries-arb #:+program-object-arb+ #:+shader-object-arb+
             #:+object-type-arb+ #:+object-subtype-arb+ #:+float-vec2-arb+
             #:+float-vec3-arb+ #:+float-vec4-arb+ #:+int-vec2-arb+
             #:+int-vec3-arb+ #:+int-vec4-arb+ #:+bool-arb+ #:+bool-vec2-arb+
             #:+bool-vec3-arb+ #:+bool-vec4-arb+ #:+float-mat2-arb+
             #:+float-mat3-arb+ #:+float-mat4-arb+ #:+sampler-1d-arb+
             #:+sampler-2d-arb+ #:+sampler-3d-arb+ #:+sampler-cube-arb+
             #:+sampler-1d-shadow-arb+ #:+sampler-2d-shadow-arb+
             #:+sampler-2d-rect-arb+ #:+sampler-2d-rect-shadow-arb+
             #:+object-delete-status-arb+ #:+object-compile-status-arb+
             #:+object-link-status-arb+ #:+object-validate-status-arb+
             #:+object-info-log-length-arb+ #:+object-attached-objects-arb+
             ...
             #:delete-object-arb #:+vertex-shader-arb+
             ...
             #:bind-attrib-location-arb #:+max-draw-buffers-arb+
             ...
             #:+draw-buffer15-arb+ #:draw-buffers-arb #:+rgba-float-mode-arb+
             #:+clamp-vertex-color-arb+ #:+clamp-fragment-color-arb+
             #:+clamp-read-color-arb+ #:+fixed-only-arb+ #:clamp-color-arb
             #:blend-color-ext #:+polygon-offset-ext+
             #:+polygon-offset-factor-ext+ #:polygon-offset-ext
             ...
             #:get-histogram-parameter-fv-ext #:get-histogram-ext
             #:separable-filter-2d-ext #:get-separable-filter-ext
             ...
             #:prioritize-textures-ext #:is-texture-ext #:gen-textures-ext
             #:delete-textures-ext #:bind-texture-ext
             #:are-textures-resident-ext #:get-detail-tex-func-sgis
             #:detail-tex-func-sgis #:get-sharpen-tex-func-sgis
             #:sharpen-tex-func-sgis #:sample-pattern-sgis #:sample-mask-sgis
             ...
             #:color-pointer-ext #:array-element-ext #:blend-equation-ext
             #:+sprite-axial-sgix+ #:+sprite-object-aligned-sgix+
             #:+sprite-eye-aligned-sgix+ #:sprite-parameter-iv-sgix
             #:sprite-parameter-i-sgix #:sprite-parameter-fv-sgix
             #:sprite-parameter-f-sgix #:point-parameter-fv-ext
             #:point-parameter-f-ext #:+point-size-min+ #:+point-size-min-arb+
             #:+point-size-min-ext+ #:+point-size-max+ #:+point-size-max-arb+
             #:+point-size-max-ext+ #:+point-fade-threshold-size+
             ...
             #:+back-normals-hint-pgi+ #:hint-pgi #:+color-index1-ext+
             #:+color-index2-ext+ #:+color-index4-ext+ #:+color-index8-ext+
             #:+color-index12-ext+ #:+color-index16-ext+
             #:+texture-index-size-ext+ #:get-color-table-parameter-fv-ext
             #:get-color-table-parameter-iv-ext #:get-color-table-ext
             #:color-table-ext #:list-parameter-iv-sgix #:list-parameter-i-sgix
             ...
             #:+index-material-face-ext+ #:index-material-ext
             #:+index-test-ext+ #:+index-test-func-ext+ #:+index-test-ref-ext+
             #:index-func-ext #:+array-element-lock-first-ext+
             #:+array-element-lock-count-ext+ #:unlock-arrays-ext
             #:lock-arrays-ext #:+cull-vertex-ext+
             #:+cull-vertex-eye-position-ext+
             #:+cull-vertex-object-position-ext+ #:cull-parameter-fv-ext
             #:cull-parameter-dv-ext #:+current-raster-normal-sgix+
             #:light-env-i-sgix #:get-fragment-material-iv-sgix
             #:get-fragment-material-fv-sgix #:get-fragment-light-iv-sgix
             #:get-fragment-light-fv-sgix #:fragment-material-iv-sgix
             #:fragment-material-i-sgix #:fragment-material-fv-sgix
             #:fragment-material-f-sgix #:fragment-light-model-iv-sgix
             #:fragment-light-model-i-sgix #:fragment-light-model-fv-sgix
             #:fragment-light-model-f-sgix #:fragment-light-iv-sgix
             #:fragment-light-i-sgix #:fragment-light-fv-sgix
             #:fragment-light-f-sgix #:fragment-color-material-sgix
             #:+max-elements-vertices-ext+ #:+max-elements-indices-ext+
             #:draw-range-elements-ext #:+fragment-material-ext+
             ...
             #:+texture-material-parameter-ext+ #:texture-material-ext
             #:texture-light-ext #:apply-texture-ext #:is-async-marker-sgix
             #:delete-async-markers-sgix #:gen-async-markers-sgix
             #:poll-async-sgix #:finish-async-sgix #:async-marker-sgix
             ...
             #:pixel-transform-parameter-i-ext #:+color-sum-ext+
             ...
             #:fog-coord-fv-ext #:fog-coord-f-ext #:+tangent-array-ext+
             ...
             #:+binormal-array-stride-ext+ #:+tangent-array-pointer-ext+
             #:+binormal-array-pointer-ext+ #:+map1-tangent-ext+
             #:+map2-tangent-ext+ #:+map1-binormal-ext+ #:+map2-binormal-ext+
             #:binormal-pointer-ext #:tangent-pointer-ext #:binormal-3sv-ext
             #:binormal-3s-ext #:binormal-3iv-ext #:binormal-3i-ext
             #:binormal-3fv-ext #:binormal-3f-ext #:binormal-3dv-ext
             #:binormal-3d-ext #:binormal-3bv-ext #:binormal-3b-ext
             #:tangent-3sv-ext #:tangent-3s-ext #:tangent-3iv-ext
             #:tangent-3i-ext #:tangent-3fv-ext #:tangent-3f-ext
             #:tangent-3dv-ext #:tangent-3d-ext #:tangent-3bv-ext
             #:tangent-3b-ext #:+unpack-constant-data-sunx+
             #:+texture-constant-data-sunx+ #:finish-texture-sunx
             #:+global-alpha-sun+ #:+global-alpha-factor-sun+
             #:global-alpha-factor-ui-sun #:global-alpha-factor-us-sun
             #:global-alpha-factor-ub-sun #:global-alpha-factor-d-sun
             #:global-alpha-factor-f-sun #:global-alpha-factor-i-sun
             #:global-alpha-factor-s-sun #:global-alpha-factor-b-sun
             #:+restart-sun+ #:+replace-middle-sun+ #:+replace-oldest-sun+
             #:+triangle-list-sun+ #:+replacement-code-sun+
             ...
             #:+modelview0-matrix-ext+ #:+modelview1-matrix-ext+
             #:+vertex-weighting-ext+ #:+modelview0-ext+ #:+modelview1-ext+
             ...
             #:vertex-weight-fv-ext #:vertex-weight-f-ext
             ...
             #:flush-vertex-array-range-nv #:+register-combiners-nv+
             #:+variable-a-nv+ #:+variable-b-nv+ #:+variable-c-nv+
             #:+variable-d-nv+ #:+variable-e-nv+ #:+variable-f-nv+
             #:+variable-g-nv+ #:+constant-color0-nv+ #:+constant-color1-nv+
             #:+primary-color-nv+ #:+secondary-color-nv+ #:+spare0-nv+
             #:+spare1-nv+ #:+discard-nv+ #:+e-times-f-nv+
             #:+spare0-plus-secondary-color-nv+ #:+unsigned-identity-nv+
             #:+unsigned-invert-nv+ #:+expand-normal-nv+ #:+expand-negate-nv+
             #:+half-bias-normal-nv+ #:+half-bias-negate-nv+
             #:+signed-identity-nv+ #:+signed-negate-nv+ #:+scale-by-two-nv+
             ...
             #:+combiner-ab-dot-product-nv+ #:+combiner-cd-dot-product-nv+
             #:+combiner-mux-sum-nv+ #:+combiner-scale-nv+ #:+combiner-bias-nv+
             ...
             #:+combiner6-nv+ #:+combiner7-nv+ #:+texture0-arb+
             #:+texture1-arb+ #:get-final-combiner-input-parameter-iv-nv
             ...
             #:set-fence-nv #:finish-fence-nv #:get-fence-iv-nv #:test-fence-nv
             #:is-fence-nv #:gen-fences-nv #:delete-fences-nv #:+eval-2d-nv+
             ...
             #:map-parameter-iv-nv #:map-control-points-nv
             #:+per-stage-constants-nv+ #:get-combiner-stage-parameter-fv-nv
             #:combiner-stage-parameter-fv-nv #:+vertex-program-nv+
             #:+vertex-state-program-nv+ #:+attrib-array-size-nv+
             #:+attrib-array-stride-nv+ #:+attrib-array-type-nv+
             #:+current-attrib-nv+ #:+program-length-nv+ #:+program-string-nv+
             ...
             #:are-programs-resident-nv #:+bump-rot-matrix-ati+
             #:+bump-rot-matrix-size-ati+ #:+bump-num-tex-units-ati+
             #:+bump-tex-units-ati+ #:+dudv-ati+ #:+du8dv8-ati+
             #:+bump-envmap-ati+ #:+bump-target-ati+
             ...
             #:+reg-3-ati+ #:+reg-4-ati+ #:+reg-5-ati+ #:+reg-6-ati+
             #:+reg-7-ati+ #:+reg-8-ati+ #:+reg-9-ati+ #:+reg-10-ati+
             #:+reg-11-ati+ #:+reg-12-ati+ #:+reg-13-ati+ #:+reg-14-ati+
             #:+reg-15-ati+ #:+reg-16-ati+ #:+reg-17-ati+ #:+reg-18-ati+
             #:+reg-19-ati+ #:+reg-20-ati+ #:+reg-21-ati+ #:+reg-22-ati+
             #:+reg-23-ati+ #:+reg-24-ati+ #:+reg-25-ati+ #:+reg-26-ati+
             #:+reg-27-ati+ #:+reg-28-ati+ #:+reg-29-ati+ #:+reg-30-ati+
             #:+reg-31-ati+ #:+con-0-ati+ #:+con-1-ati+ #:+con-2-ati+
             #:+con-3-ati+ #:+con-4-ati+ #:+con-5-ati+ #:+con-6-ati+
             #:+con-7-ati+ #:+con-8-ati+ #:+con-9-ati+ #:+con-10-ati+
             #:+con-11-ati+ #:+con-12-ati+ #:+con-13-ati+ #:+con-14-ati+
             #:+con-15-ati+ #:+con-16-ati+ #:+con-17-ati+ #:+con-18-ati+
             #:+con-19-ati+ #:+con-20-ati+ #:+con-21-ati+ #:+con-22-ati+
             #:+con-23-ati+ #:+con-24-ati+ #:+con-25-ati+ #:+con-26-ati+
             #:+con-27-ati+ #:+con-28-ati+ #:+con-29-ati+ #:+con-30-ati+
             #:+con-31-ati+ #:+mov-ati+ #:+add-ati+ #:+mul-ati+ #:+sub-ati+
             #:+dot3-ati+ #:+dot4-ati+ #:+mad-ati+ #:+lerp-ati+ #:+cnd-ati+
             #:+cnd0-ati+ #:+dot2-add-ati+ #:+secondary-interpolator-ati+
             #:+num-fragment-registers-ati+ #:+num-fragment-constants-ati+
             #:+num-passes-ati+ #:+num-instructions-per-pass-ati+
             ...
             #:pntriangles-i-ati #:+static-ati+ #:+dynamic-ati+
             ...
             #:new-object-buffer-ati #:+vertex-shader-ext+
             ...
             #:begin-vertex-shader-ext #:+max-vertex-streams-ati+
             #:+vertex-stream0-ati+ #:+vertex-stream1-ati+
             #:+vertex-stream2-ati+ #:+vertex-stream3-ati+
             #:+vertex-stream4-ati+ #:+vertex-stream5-ati+
             #:+vertex-stream6-ati+ #:+vertex-stream7-ati+
             #:+vertex-source-ati+ #:vertex-blend-env-f-ati
             #:vertex-blend-env-i-ati #:client-active-vertex-stream-ati
             #:normal-stream-3dv-ati #:normal-stream-3d-ati
             #:normal-stream-3fv-ati #:normal-stream-3f-ati
             #:normal-stream-3iv-ati #:normal-stream-3i-ati
             #:normal-stream-3sv-ati #:normal-stream-3s-ati
             #:normal-stream-3bv-ati #:normal-stream-3b-ati
             #:vertex-stream-4dv-ati #:vertex-stream-4d-ati
             #:vertex-stream-4fv-ati #:vertex-stream-4f-ati
             #:vertex-stream-4iv-ati #:vertex-stream-4i-ati
             #:vertex-stream-4sv-ati #:vertex-stream-4s-ati
             #:vertex-stream-3dv-ati #:vertex-stream-3d-ati
             #:vertex-stream-3fv-ati #:vertex-stream-3f-ati
             #:vertex-stream-3iv-ati #:vertex-stream-3i-ati
             #:vertex-stream-3sv-ati #:vertex-stream-3s-ati
             #:vertex-stream-2dv-ati #:vertex-stream-2d-ati
             #:vertex-stream-2fv-ati #:vertex-stream-2f-ati
             #:vertex-stream-2iv-ati #:vertex-stream-2i-ati
             #:vertex-stream-2sv-ati #:vertex-stream-2s-ati
             #:vertex-stream-1dv-ati #:vertex-stream-1d-ati
             #:vertex-stream-1fv-ati #:vertex-stream-1f-ati
             #:vertex-stream-1iv-ati #:vertex-stream-1i-ati
             #:vertex-stream-1sv-ati #:vertex-stream-1s-ati
             #:+element-array-ati+ #:+element-array-type-ati+
             #:+element-array-pointer-ati+ #:draw-range-element-array-ati
             #:draw-element-array-ati #:element-pointer-ati #:+quad-mesh-sun+
             #:+triangle-mesh-sun+ #:draw-mesh-arrays-sun
             #:+pixel-counter-bits-nv+ #:+current-occlusion-query-id-nv+
             #:+pixel-count-nv+ #:+pixel-count-available-nv+
             #:get-occlusion-query-uiv-nv #:get-occlusion-query-iv-nv
             #:end-occlusion-query-nv #:begin-occlusion-query-nv
             #:is-occlusion-query-nv #:delete-occlusion-queries-nv
             #:gen-occlusion-queries-nv #:+point-sprite-nv+
             #:+coord-replace-nv+ #:+point-sprite-r-mode-nv+
             #:point-parameter-iv-nv #:point-parameter-i-nv
             #:+stencil-test-two-side-ext+ #:+active-stencil-face-ext+
             #:active-stencil-face-ext #:+element-array-apple+
             ...
             #:+draw-pixels-apple+ #:+fence-apple+ #:finish-object-apple
             #:test-object-apple #:finish-fence-apple #:test-fence-apple
             #:is-fence-apple #:set-fence-apple #:delete-fences-apple
             #:gen-fences-apple #:+vertex-array-binding-apple+
             #:is-vertex-array-apple #:gen-vertex-arrays-apple
             #:delete-vertex-arrays-apple #:bind-vertex-array-apple
             ...
             #:+half-float-nv+ #:vertex-attribs-4hv-nv #:vertex-attribs-3hv-nv
             #:vertex-attribs-2hv-nv #:vertex-attribs-1hv-nv
             #:vertex-attrib-4hv-nv #:vertex-attrib-4h-nv
             #:vertex-attrib-3hv-nv #:vertex-attrib-3h-nv
             ...
             #:vertex-2hv-nv #:vertex-2h-nv #:+write-pixel-data-range-nv+
             ...
             #:program-local-parameter-i-4i-nv #:+geometry-program-nv+
             #:+max-program-output-vertices-nv+
             #:+max-program-total-output-components-nv+
             #:framebuffer-texture-face-ext #:framebuffer-texture-layer-ext
             #:framebuffer-texture-ext #:program-vertex-limit-nv
             #:+geometry-shader-ext+ #:+geometry-vertices-out-ext+
             #:+geometry-input-type-ext+ #:+geometry-output-type-ext+
             ...
             #:+framebuffer-attachment-layered-ext+ #:+program-point-size-ext+
             #:program-parameter-i-ext #:+vertex-attrib-array-integer-nv+
             #:get-vertex-attrib-i-uiv-ext #:get-vertex-attrib-i-iv-ext
             #:vertex-attrib-ipointer-ext #:vertex-attrib-i-4usv-ext
             #:vertex-attrib-i-4ubv-ext #:vertex-attrib-i-4sv-ext
             #:vertex-attrib-i-4bv-ext #:vertex-attrib-i-4uiv-ext
             #:vertex-attrib-i-3uiv-ext #:vertex-attrib-i-2uiv-ext
             #:vertex-attrib-i-1uiv-ext #:vertex-attrib-i-4iv-ext
             #:vertex-attrib-i-3iv-ext #:vertex-attrib-i-2iv-ext
             #:vertex-attrib-i-1iv-ext #:vertex-attrib-i-4ui-ext
             #:vertex-attrib-i-3ui-ext #:vertex-attrib-i-2ui-ext
             #:vertex-attrib-i-1ui-ext #:vertex-attrib-i-4i-ext
             #:vertex-attrib-i-3i-ext #:vertex-attrib-i-2i-ext
             #:vertex-attrib-i-1i-ext #:+sampler-1d-array-ext+
             #:+sampler-2d-array-ext+ #:+sampler-buffer-ext+
             #:+sampler-1d-array-shadow-ext+ #:+sampler-2d-array-shadow-ext+
             #:+sampler-cube-shadow-ext+ #:+unsigned-int-vec2-ext+
             #:+unsigned-int-vec3-ext+ #:+unsigned-int-vec4-ext+
             #:+int-sampler-1d-ext+ #:+int-sampler-2d-ext+
             #:+int-sampler-3d-ext+ #:+int-sampler-cube-ext+
             ...
             #:clear-depth-d-nv #:depth-ranged-nv
             ...
             #:begin-transform-feedback-nv #:+max-vertex-bindable-uniforms-ext+
             ...
             #:+rgba32ui-ext+ #:+rgb32ui-ext+ #:+alpha32ui-ext+
             #:+intensity32ui-ext+ #:+luminance32ui-ext+
             #:+luminance-alpha32ui-ext+ #:+rgba16ui-ext+ #:+rgb16ui-ext+
             #:+alpha16ui-ext+ #:+intensity16ui-ext+ #:+luminance16ui-ext+
             #:+luminance-alpha16ui-ext+ #:+rgba8ui-ext+ #:+rgb8ui-ext+
             #:+alpha8ui-ext+ #:+intensity8ui-ext+ #:+luminance8ui-ext+
             #:+luminance-alpha8ui-ext+ #:+rgba32i-ext+ #:+rgb32i-ext+
             #:+alpha32i-ext+ #:+intensity32i-ext+ #:+luminance32i-ext+
             #:+luminance-alpha32i-ext+ #:+rgba16i-ext+ #:+rgb16i-ext+
             #:+alpha16i-ext+ #:+intensity16i-ext+ #:+luminance16i-ext+
             #:+luminance-alpha16i-ext+ #:+rgba8i-ext+ #:+rgb8i-ext+
             #:+alpha8i-ext+ #:+intensity8i-ext+ #:+luminance8i-ext+
             #:+luminance-alpha8i-ext+ #:+red-integer-ext+
