...
(defpackage #:cl-glfw-opengl-nv_texture_shader3-system
  (:use #:asdf #:cl)) 
(in-package #:cl-glfw-opengl-nv_texture_shader3-system) 
(defsystem cl-glfw-opengl-nv_texture_shader3 :description
 "cl-glfw's nv_texture_shader3 binding" :author
 ...
 ((:file "opengl-nv_texture_shader3"))) 
