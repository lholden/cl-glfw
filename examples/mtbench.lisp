...
(defparameter *done-mutex* (glfw:create-mutex))
(defparameter *thread-done* (glfw:create-cond))
(defparameter *goto-a* (make-instance 'thread-signal))
(defparameter *goto-b* (make-instance 'thread-signal))
